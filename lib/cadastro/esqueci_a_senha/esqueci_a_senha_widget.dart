...
class EsqueciASenhaWidget extends StatefulWidget {
  ...
  static String routeName = 'Esqueci_a_senha';
  static String routePath = '/esqueciASenha';
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children: [
                        Text(
                          'Lembrou sua senha? Clique            para fazer o login',
                          style:
                        ...
                        Align(
                          alignment: AlignmentDirectional(0.48, -1.01),
                          child: FFButtonWidget(
                            onPressed: () async {
