...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.cdastrosenhaTextController1 ??= TextEditingController();
    _model.cdastrosenhaFocusNode1 ??= FocusNode();

    _model.cdastrosenhaTextController2 ??= TextEditingController();
    _model.cdastrosenhaFocusNode2 ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Insira seu nome, e-mail e escolha uma senha',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.inter(
                              fontWeight: FontWeight.w800,
                              fontStyle: FlutterFlowTheme.of(context)
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.cadastroNomeTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        enableInteractiveSelection: true,
                        validator: _model.cadastroEmailTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      width: 350.0,
                      child: TextFormField(
                        controller: _model.cdastrosenhaTextController1,
                        focusNode: _model.cdastrosenhaFocusNode1,
                        autofocus: false,
                        enabled: true,
                        obscureText: false,
                        decoration: InputDecoration(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        enableInteractiveSelection: true,
                        validator: _model.cdastrosenhaTextController1Validator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      width: 350.0,
                      child: TextFormField(
                        controller: _model.cdastrosenhaTextController2,
                        focusNode: _model.cdastrosenhaFocusNode2,
                        autofocus: false,
                        enabled: true,
                        obscureText: !_model.cdastrosenhaVisibility,
                        decoration: InputDecoration(
                          isDense: true,
                          labelStyle:
                              FlutterFlowTheme.of(context).labelMedium.override(
                          ...
                          suffixIcon: InkWell(
                            onTap: () async {
                              safeSetState(() => _model.cdastrosenhaVisibility =
                                  !_model.cdastrosenhaVisibility);
                            },
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        enableInteractiveSelection: true,
                        validator: _model.cdastrosenhaTextController2Validator
                            .asValidator(context),
                      ),
                    ),
                  ),
