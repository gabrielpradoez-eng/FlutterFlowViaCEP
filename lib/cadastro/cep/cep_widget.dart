...
class CepWidget extends StatefulWidget {
  ...
  static String routeName = 'CEP';
  static String routePath = '/cep';
...
class _CepWidgetState extends State<CepWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CepModel());
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                _model.apiResultadocep = await ConCepCall.call(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            enableInteractiveSelection: true,
                            validator: _model.textFieldufTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
