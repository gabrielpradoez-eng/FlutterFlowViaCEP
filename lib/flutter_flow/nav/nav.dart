...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/SaborLocal_(2).gif',
                  fit: BoxFit.cover,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          name: EsqueciASenhaWidget.routeName,
          path: EsqueciASenhaWidget.routePath,
        ...
        FFRoute(
          ...
          path: CepWidget.routePath,
          builder: (context, params) => CepWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BuscaWidget.routeName,
          path: BuscaWidget.routePath,
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'Busca') : BuscaWidget(),
        ),
        FFRoute(
